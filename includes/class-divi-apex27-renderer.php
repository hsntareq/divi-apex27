...
class Divi_Apex27_Renderer {
	...
	private static function current_query( array $props ) {
		...
		$aliases = array(
			...
			'min_price'     => array( 'apex27_min_price', 'min_price', 'minPrice' ),
			'max_price'     => array( 'apex27_max_price', 'max_price', 'maxPrice' ),
			'min_beds'      => array( 'apex27_min_beds', 'min_beds', 'minBeds' ),
			'max_beds'      => array( 'apex27_max_beds', 'max_beds', 'maxBeds' ),
